  ...
  function buildHeader() {
    ...
    h.innerHTML =
      ...
      '<div class="brand-bar__actions">' +
        ...
        '</a>' +
        '<button class="brand-bar__cta" type="button" aria-haspopup="dialog">Все проекты</button>' +
      '</div>';
    h.querySelector('.brand-bar__cta').addEventListener('click', function () { toggleProjectSwitcher(true); });
